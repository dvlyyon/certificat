...
openssl ecparam -name secp512r1 -genkey -out $pr_dir/$leaf_name3.key
...
openssl pkcs12 -export -name "My Certificates $leaf_name2" -out $leaf_name2.pfx -inkey private/$leaf_name2.key -in $leaf_name2.crt 
openssl pkcs12 -export -name "My Certificates $leaf_name3" -out $leaf_name3.pfx -inkey private/$leaf_name3.key -in $leaf_name3.crt 
